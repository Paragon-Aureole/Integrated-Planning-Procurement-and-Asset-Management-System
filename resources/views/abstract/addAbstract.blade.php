            ...
            <table id="prDatatable" class="table table-bordered table-hover table-sm display nowrap w-100">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <button type="button" class="btn btn-sm btn-primary" data-prcode="{{$pr->pr_code}}"
                      data-prid="{{$pr->id}}" data-prpurpose="{{$pr->pr_purpose}}" data-toggle="modal"
                      data-target="#myModal" name="abstractContent">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form autocomplete="off" action="{{route('abstract.store')}}" method="POST" class="needs-validation"
                  novalidate>
                  {{ csrf_field() }}
                      ...
                      <div class="form-group">
                        ...
                        <div>
                          <div class="form-group">
                            ...
                            <div><br />
                              <div class="form-group">
                                <button class="btn btn-primary" data-toggle="confirmation" type="submit">Create Abstract
                                  of Quotation</button>
                              </div>
                </form>
              </div>
