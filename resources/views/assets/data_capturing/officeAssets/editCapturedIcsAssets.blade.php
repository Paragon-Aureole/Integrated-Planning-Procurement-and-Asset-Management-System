                    ...
                    <div class="col-md-12">
                        ...
                        <div id="office_assets" style="display:none">
                            <form action="{{route('migrateAssets.store')}}" method="POST" class="needs-validation" novalidate>
                                ...
                                <div id="cloneInputs">
                                    <div class="row">
                                        <input type="text" value="" id="classification_id[]" name="classification" hidden>
                                        <input type="text" value=""  id="asset_type_id" name="asset_type_id[]" hidden>
                                        <div class="col-sm-2">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" id="fund_cluster" name="fund_cluster[]" class="form-control form-control-sm" value="" required>
                                            </div> 
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
                                                <label class="small">Receiver name:</label>
                                                <input type="text" id="receiver_name" name="receiver_name[]" class="form-control form-control-sm" value="" required>
                                            </div> 
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
                                                <label class="small">Receiver Position:</label>
                                                <input type="text" id="receiver_position" name="receiver_position[]" class="form-control form-control-sm" value="" required>
                                            </div> 
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
                                                <label class="small">Issuer Name:</label>
                                                <input type="text" id="issuer_name" name="issuer_name[]" class="form-control form-control-sm" value="" required>
                                            </div> 
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
                                                <label class="small">Issuer Position:</label>
                                                <input type="text" id="issuer_position" name="issuer_position[]" class="form-control form-control-sm" value="" required>
                                            </div> 
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="number" id="item_quantity" name="item_quantity[]" class="form-control form-control-sm" value="" required>
                                            </div> 
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
                                                <label class="small">Item Unit:</label>
                                                <input type="text" id="item_unit" name="item_unit[]" class="form-control form-control-sm" value="" required>
                                            </div> 
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
                                                <label class="small">Property Number:</label>
                                                <input type="text" id="property_number" name="property_number[]" class="form-control form-control-sm" value="" required>
                                            </div> 
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
                                                <label class="small">Date Acquired:</label>
                                                <input type="date" id="date_acquired" name="date_acquired[]" class="form-control form-control-sm" value="" required>
                                            </div> 
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
                                                <label class="small">Unit Cost:</label>
                                                <input type="number" id="unit_cost" name="unit_cost[]" class="form-control form-control-sm" value="" required>
                                            </div> 
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
                                                <label class="small">Amount:</label>
                                                <input type="number" id="amount" name="amount[]" class="form-control form-control-sm" value="" required>
                                            </div> 
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" id="par_number" name="par_number[]" class="form-control form-control-sm" value="" required>
                                            </div> 
                                        </div>
                                        <div class="col-sm-10">
                        ...
                        <div id="vehicle" >
                            <form action="{{route('migrateIcsAssets.update', $data->id)}}" method="POST" class="needs-validation" novalidate>
                                <div id="cloneIcs">
                                    {{method_field('PUT')}}
                                    <div class="row">
                                            <input value="{{$data->classification}}" type="text" id="classification_id_ics" name="classification_ics" hidden>
                                            <input type="text" value="{{$data->asset_type_id}}" id="asset_type_id_ics" name="asset_type_id_ics" hidden>
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
                                                <label class="small">Receiver Name:</label>
                                                <input type="text" value="{{$data->receiver_name}}" id="receiver_name_ics" name="receiver_name" class="form-control form-control-sm" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
                                                <label class="small">Receiver Position:</label>
                                                <input type="text" value="{{$data->receiver_position}}" id="receiver_position_ics" name="receiver_position" class="form-control form-control-sm" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
                                                <label class="small">Issuer Name:</label>
                                                <input type="text" value="{{$data->issuer_name}}" id="issuer_name_ics" name="issuer_name" class="form-control form-control-sm" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
                                                <label class="small">Issuer Position:</label>
                                                <input type="text" value="{{$data->issuer_position}}" id="issuer_position_ics" name="issuer_position" class="form-control form-control-sm" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
                                                <label class="small">Item Quantity:</label>
                                                <input type="number" value="{{$data->item_quantity}}" id="item_quantity_ics" name="item_quantity" class="form-control form-control-sm" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" value="{{$data->inventory_item_number}}" id="inventory_item_number_ics" name="inventory_item_number" class="form-control form-control-sm" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
                                                <label class="small">Estimated Useful Life:</label>
                                                <input type="text" value="{{$data->estimated_useful_life}}" id="estimated_useful_life_ics" name="estimated_useful_life" class="form-control form-control-sm" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-2">
                                            <div class="form-group col-md-12">
