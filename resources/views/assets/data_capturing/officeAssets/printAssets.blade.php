    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <table class=" table table-bordered table-hover table-sm table-condensed display nowrap w-100">
                ...
                <tbody>
                    <tr>
                        <td style="background-color:yellow">ENGINEERING</td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td>Sample Unit of</td>
                        <td>Sample Unit</td>
                        <td>Sample Balance</td>
                        <td>Sample On hand</td>
                        <td>Sample Shortage/overage</td>
                        <td>Sampel Date of Purchase</td>
                        <td>Sample Par Number</td>
                        <td>Sample Status</td>
