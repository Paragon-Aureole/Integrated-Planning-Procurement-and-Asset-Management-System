...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 text-center">
				<h4><b><i>ACCEPTANCE AND INSPECTION REPORT</i></b></h4>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 text-center">
				<h5><u>City Government of San Fernando</u></h5>
			</div>
		</div>
		<div class="row" style="border:1px solid #262626;">
			...
			<div class="col-xs-12" style="padding: 1px 5px 5px 5px;">
				<div class="col-xs-6 " style="padding: 0px;">
					...
					<div class="col-xs-10" style="padding: 0px;">
						{{$ir->purchaseRequest->purchaseOrder->outlineSupplier->supplier_name}}
						<hr>
					</div>
				</div>
				<div class="col-xs-4" style="padding: 0px;">
					<div class="col-xs-4" style="padding:2px 0px 0px;">AIR No.:</div>
					<div class="col-xs-8" style="padding: 0px;">{{$ir->id}}
						<hr>
					</div>
				</div>
			</div><br>
			<div class="col-xs-12" style="padding: 1px 5px 5px 5px;">
				<div class="col-xs-3" style="padding: 0px;">
					...
					<div class="col-xs-8" style="padding: 0px;">{{$ir->purchaseRequest->purchaseOrder->id}}
						<hr>
					</div>
				</div>
				<div class="col-xs-3" style="padding: 0px;">
					...
					<div class="col-xs-8" style="padding: 0px;">
						{{Carbon\Carbon::parse($ir->purchaseRequest->purchaseOrder->created_at)->Format('F j, Y')}}
						<hr>
					</div>
				</div>
				<div class="col-xs-3" style="padding: 0px;">
					<div class="col-xs-5" style="padding:2px 0px 0px;">Invoice No.:</div>
					<div class="col-xs-7" style="padding: 0px;">{{$ir->invoice_number}}
						<hr>
					</div>
				</div>
				<div class="col-xs-3" style="padding: 0px;">
					<div class="col-xs-4" style="padding:2px 0px 0px;">Date:</div>
					<div class="col-xs-8" style="padding: 0px;">&nbsp;{{$date->Format('F j, Y')}}
						<hr>
					</div>
				</div>
			</div><br>
			<div class="col-xs-12" style="padding: 1px 5px 5px 5px;">
				...
				<div class="col-xs-8" style="padding: 0px;">{{$ir->purchaseRequest->office->office_name}}
					<hr>
				</div>
			</div>
			<div class="col-xs-12">&nbsp;</div>
		...
		<div class="row">
			<div class="col-xs-6" style="border:1px solid #262626;">
				...
				<div class="col-xs-2" style="padding: 0px;">
					<div style="margin: 0px;" class="well"></div>
				</div>
				...
				<div class="col-xs-12">&nbsp;</div>
				<div class="col-xs-12">&nbsp;</div>
				<div class="col-xs-12 text-center">{{strtoUpper($ir->property_officer)}}
					<hr>
				</div>
			...
			<div class="col-xs-6" style="border:1px solid #262626;">
				...
				<div class="col-xs-12">&nbsp;</div>
				<div class="col-xs-12">&nbsp;</div>
				<div class="col-xs-12 text-center">{{strtoUpper($ir->inspection_officer)}}
					<hr>
				</div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 text-center">
				<h4><b><i>REQUISITION AND ISSUE SLIP</i></b></h4>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 text-center">
		...
		<div class="row">
			<div class="col-xs-3" style="padding: 1px 5px 5px 5px;border:1px solid #262626;">
				...
				<div class="col-xs-12">{{$ir->purchaseRequest->office->office_code}}
					<hr>
				</div>
			</div>
			<div class="col-xs-3" style="padding: 1px 5px 5px 5px;border:1px solid #262626;">
			...
			<div class="col-xs-6" style="padding: 1px 5px 5px 5px;border:1px solid #262626;">
				<div class="col-xs-7">RIS No:
					<hr style="margin-left:50px;">
				</div>
				<div class="col-xs-5">Date:
					<hr style="margin-left:40px;">
				</div><br><br>
				<div class="col-xs-7">SAI No:
					<hr style="margin-left:50px;">
				</div>
				<div class="col-xs-5">Date:
					<hr style="margin-left:40px;">
		...
		<div class="row">
			<table class="table table-condensed content">
				<thead>
					...
					<tr>
						<td>Printed Name</td>
						<th>@if($ir->purchaseRequest->signatory !=
							NULL){{strtoUpper($ir->purchaseRequest->signatory->signatory_name)}}@endif</th>
					...
					<tr>
						<td>Designation</td>
						<th>@if($ir->purchaseRequest->signatory !=
							NULL){{$ir->purchaseRequest->signatory->signatory_position}}@endif</th>
