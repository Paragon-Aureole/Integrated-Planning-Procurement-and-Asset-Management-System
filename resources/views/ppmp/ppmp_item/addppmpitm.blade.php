            ...
            <div class="row">
              <div class="form-group col-md-12">
                ...
                <div class="input-group mb-3">
                  <select class="custom-select custom-select-sm {{ $errors->has('item_code') ? 'is-invalid' : '' }}"
                    name="item_code" required="required">
                  ...
                  <div class="input-group-append">
                    <button type="button" class="btn btn-outline-secondary btn-sm" data-toggle="modal"
                      data-target="#itemCodeModal">Add Item Code</button>
                  </div>
              ...
              <div class="form-group col-md-12">
                ...
                <textarea
                  class="form-control form-control-sm {{ $errors->has('item_description') ? 'is-invalid' : '' }}"
                  name="item_description" rows="3" required="required"></textarea>
                <div class="invalid-feedback">
              ...
              <div class="form-group col-md-12">
                ...
                <select class="custom-select custom-select-sm {{ $errors->has('item_mode') ? 'is-invalid' : '' }}"
                  name="item_mode" required="required">
                  @foreach($modes as $mode)
                  <option value="{{$mode->id}}" {{ old('item_unit') == $mode->id ? 'selected' : '' }}>
              ...
              <div class="form-group col-md-6">
                ...
                <input oninput="multiply();" id="itemQty"
                  class="form-control form-control-sm {{ $errors->has('item_quantity') ? 'is-invalid' : '' }}"
                  value="{{ old('item_quantity') }}" value="{{ old('item_quantity') }}" name="item_quantity"
                  required="required">
                <div class="invalid-feedback">
              ...
              <div class="form-group col-md-6">
                ...
                <select class="custom-select custom-select-sm {{ $errors->has('item_unit') ? 'is-invalid' : '' }}"
                  name="item_unit" required="required">
                  @foreach($units as $unit)
                  <option value="{{$unit->id}}" {{ old('item_unit') == $unit->id ? 'selected' : '' }}>
                    {{$unit->unit_description}}</option>
                  @endforeach
                </select>
                <div class="invalid-feedback">
              ...
              <div class="form-group col-md-6">
                ...
                <input oninput="multiply();" id="itemCost"
                  class="form-control form-control-sm {{ $errors->has('item_cost') ? 'is-invalid' : '' }}"
                  value="{{ old('item_cost') }}" name="item_cost" required="required">
                <div class="invalid-feedback">
              ...
              <div class="form-group col-md-6">
                ...
                <input id="itemBudget"
                  class="form-control form-control-sm {{ $errors->has('item_budget') ? 'is-invalid' : '' }}"
                  value="{{ old('item_budget', number_format(0,2)) }}" name="item_budget" readonly="readonly"
                  required="required">
                <div class="invalid-feedback">
...
>>>>>>> 6989931f6bb0821d05ee7a136621b3ea958f5828
          ...
          <div class="col-md-6">
            ...
            <hr class="mt-0">
            <div class="row">
              @for($s=1; $s<=12; $s++) @php $month_num=$s-1; @endphp <div class="form-group col-md-4">
                <label class="small">{{strtoupper(date('M', mktime(0, 0, 0, $s, 1)))}}</label>
                <input
                  class="form-control form-control-sm {{ $errors->has('item_schedule.'.$month_num) ? 'is-invalid' : '' }}"
                  name="item_schedule[{{$month_num}}]" value="{{ old('item_schedule.'.$month_num, '0' ) }}">
                <div class="invalid-feedback">
                  ...
                  <form action="{{route('add.ppmpitemcode', $ppmp->id)}}" method="POST" id="needs-validation2"
                    ...
                    <div class="row">
                      <div class="form-group col-md-12">
                        ...
                        <input id="descriptionValue"
                          class="form-control form-control-sm {{ $errors->has('code_description') ? 'is-invalid' : '' }}"
                          name="code_description" value="{{ old('code_description') }}" required>
                        <div class="invalid-feedback">
...
>>>>>>> 6989931f6bb0821d05ee7a136621b3ea958f5828
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <select id="optionValue"
                          class="custom-select custom-select-sm {{ $errors->has('code_type') ? 'is-invalid' : '' }}"
                          name="code_type" required>
